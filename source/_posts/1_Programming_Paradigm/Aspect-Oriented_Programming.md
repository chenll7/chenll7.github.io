---
title: '面向切面编程（Aspect-Oriented Programming, AOP）'
date: '2021-05-20 14:33:25'
updated: '2021-05-20 14:51:18'
categories:
  - 1 Programming Paradigm
---
# 面向切面编程（Aspect-Oriented Programming, AOP）

　　运行时或者编译时，动态地将代码切入到类的指定方法、指定位置上的编程思想就是面向切面的编程。
...
>　　AOP在编程历史上可以说是里程碑式的，对OOP编程是一种十分有益的补充。[^1]

　　Spring的AOP实现就是基于JVM的动态代理。

## 参考

[^1]: [什么是面向切面编程AOP？ - 知乎](https://www.zhihu.com/question/24863332/answer/48376158)
